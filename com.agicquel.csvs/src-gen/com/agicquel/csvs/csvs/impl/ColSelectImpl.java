...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Col Select</b></em>'.
 * <!-- end-user-doc -->
 * <p>
...
public class ColSelectImpl extends SelectorImpl implements ColSelect
{
  ...
  {
    return CsvsPackage.Literals.COL_SELECT;
  }
  ...
  public NotificationChain basicSetExpression(PrimaryExpr newExpression, NotificationChain msgs)
  {
    ...
    if (eNotificationRequired())
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, CsvsPackage.COL_SELECT__EXPRESSION, oldExpression, newExpression);
  ...
  public void setExpression(PrimaryExpr newExpression)
  {
    if (newExpression != expression)
    {
      ...
      if (expression != null)
        msgs = ((InternalEObject)expression).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - CsvsPackage.COL_SELECT__EXPRESSION, null, msgs);
      if (newExpression != null)
        msgs = ((InternalEObject)newExpression).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - CsvsPackage.COL_SELECT__EXPRESSION, null, msgs);
      msgs = basicSetExpression(newExpression, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, CsvsPackage.COL_SELECT__EXPRESSION, newExpression, newExpression));
  }
